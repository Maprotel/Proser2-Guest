...
@Component({
  selector: 'app-view-display-monitor-indicators-summary',
  templateUrl: './display-monitor-indicators-summary.component.html',
  styleUrls: ['./display-monitor-indicators-summary.component.scss']
})
export class DisplayMonitorIndicatorsSummaryComponent implements OnInit {
  // Subscription
  ...
  ngOnInit() {
    this.title = ("Indicadores acumulado");
